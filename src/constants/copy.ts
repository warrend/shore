export const WELCOME_COPY: string =
  'Welcome to Raft. Please click to continue.';
export const SLIDER_MESSAGE_ALL_COMPLETE: string =
  'Congrats, you finished all the lessons!';
export const SLIDER_MESSAGE_LAST_LESSON: string =
